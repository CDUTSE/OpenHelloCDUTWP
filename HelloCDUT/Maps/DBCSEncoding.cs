...
namespace DBCSCodePage
{
    public sealed class DBCSEncoding : Encoding
    {
        ...
        public static DBCSEncoding GetDBCSEncoding(string name)
        {
            ...
            using (Stream stream = (typeof(DBCSEncoding)).GetTypeInfo().Assembly.GetManifestResourceStream(typeof(DBCSEncoding).Namespace + "." + name + ".bin"))
            ...
            //StreamReader sr = new StreamReader(streamResponse, DBCSCodePage.DBCSEncoding.GetDBCSEncoding("gb2312"));
