...
namespace 你好理工.Controls
{
    ...
    public class PieChart : Control
    {
        ...
        {
            new SolidColorBrush(Color.FromArgb(0xFF,0x80,0xBB,0x01)),   //微软绿
            new SolidColorBrush(Color.FromArgb(0xFF,0xF2,0x50,0x22)),   //微软橙
            new SolidColorBrush(Color.FromArgb(0xFF,0x02,0xA4,0xEF)),   //微软蓝
            new SolidColorBrush(Color.FromArgb(0xFF,0xFF,0xB9,0x02)),   //微软黄
